...
SERVER_ROOT = "http://127.0.0.1:8005"
...
async def main() -> int:
    print("Persistent home + persistent project demo client")
    print("This client creates one workspace, optionally bootstraps/reuses a repo, and retains storage across delete/recreate.")
    ...
    async with aiohttp.ClientSession() as http_session:
        try:
            ...
            print("Start stage6_server.py in another terminal first.")
            return 1
        except RuntimeError as exc:
            print(exc)
            return 1
        ...
        print(f"storage_persistent: {workspace_snapshot['storage_persistent']}")
        ...
        try:
            ...
            await delete_workspace(http_session, workspace_id)
            print("Client closed. Persistent storage was retained.")
