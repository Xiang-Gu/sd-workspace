...
DATA_ROOT = os.path.join(BASE_DIRECTORY, ".stage8_data")
...
def attach_runtime(workspace: Workspace) -> None:
    runtime = create_shell_runtime(workspace.loop, workspace.project_root, workspace.home_root)
...
def main() -> None:
    ...
    print("Idle suspend/resume demo server")
