...
SERVER_ROOT = "http://127.0.0.1:8010"
...
async def main() -> int:
    print("Distributed workspace demo client")
    print("This client still talks only to the control plane, which now schedules workspaces onto separate worker processes.")
    ...
    async with aiohttp.ClientSession() as http_session:
        try:
            ...
            print("Start stage11_server.py and the Stage 11 workers in other terminals first.")
            return 1
        except RuntimeError as exc:
            print(exc)
            return 1
