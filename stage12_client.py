...
SERVER_ROOT = "http://127.0.0.1:8013"
...
async def main() -> int:
    print("Fair scheduler workspace demo client")
    print("This client talks to the control plane, which admits per-owner usage and places runtimes by projected worker load.")
    ...
    async with aiohttp.ClientSession() as http_session:
        try:
            ...
            print("Start stage12_server.py and the Stage 12 workers in other terminals first.")
            return 1
        except RuntimeError as exc:
            print(exc)
            return 1
