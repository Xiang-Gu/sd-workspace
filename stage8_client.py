...
SERVER_ROOT = "http://127.0.0.1:8007"
...
async def main() -> int:
    print("Idle suspend/resume demo client")
    print("This client reuses an existing workspace when owner and name match, and only deletes on /delete.")
    ...
    async with aiohttp.ClientSession() as http_session:
        try:
            ...
            print("Start stage8_server.py in another terminal first.")
            return 1
        except RuntimeError as exc:
            print(exc)
            return 1
