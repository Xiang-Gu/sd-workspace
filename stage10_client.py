...
SERVER_ROOT = "http://127.0.0.1:8009"
...
async def main() -> int:
    print("Resource-limited workspace demo client")
    print("This client reuses an existing workspace when owner and name match, and requests a resource profile when creating a new workspace.")
    ...
    async with aiohttp.ClientSession() as http_session:
        try:
            ...
            print("Start stage10_server.py in another terminal first.")
            return 1
        except RuntimeError as exc:
            print(exc)
            return 1
