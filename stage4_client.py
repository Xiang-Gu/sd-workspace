...
SERVER_ROOT = "http://127.0.0.1:8003"
...
async def main() -> int:
    print("Workspace plus filesystem demo client")
    print("This client creates one workspace, attaches to its shell, and can call file APIs.")
    print("Type /help for client-side file commands.")
    print("")
    ...
    async with aiohttp.ClientSession() as http_session:
        try:
            ...
            print("Start stage4_server.py in another terminal first.")
            return 1
        except RuntimeError as exc:
            print(exc)
            return 1
        ...
        print(f"workspace root: {workspace_snapshot['working_directory']}")
