...
CONTROL_PLANE_URL = "http://127.0.0.1:8013"
...
async def register_with_control_plane(app: web.Application) -> None:
...
async def registration_loop(app: web.Application) -> None:
    while True:
        await register_with_control_plane(app)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--control-plane-url", default="http://127.0.0.1:8013")
...
def main() -> None:
    ...
    print(f"Stage 12 worker {WORKER_ID}")
